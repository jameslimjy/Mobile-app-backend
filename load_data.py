...
with open(data_folder_path + data_file['REPORT'], 'r') as f:
    ...
    for line in f:
        ...
        submit_to_tc = l[8]
        new_report = Report(title = title, description = description, street_name = street_name, postal_code = postal_code, nearby_landmarks = nearby_landmarks, latitude = latitude, longitude = longitude, submitted_by_user = submitted_by_user, submit_to_tc = submit_to_tc)
